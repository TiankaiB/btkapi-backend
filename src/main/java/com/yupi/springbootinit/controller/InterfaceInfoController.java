...
public class InterfaceInfoController {
    ...
    @Resource
    private BtkApiClient btkApiClient;
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.btk.btkapiclientsdk.model.User user = new com.btk.btkapiclientsdk.model.User();
        user.setUsername("test");
        String username = btkApiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        BtkApiClient tempClient = new BtkApiClient(accessKey,secretKey);
        Gson gson = new Gson();
        com.btk.btkapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.btk.btkapiclientsdk.model.User.class);
